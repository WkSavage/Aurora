...
/datum/game_mode/heist/proc/greet_vox(var/datum/mind/raider)
	...
	raider.current << "\blue The Vox are a race of cunning, sharp-eyed nomadic raiders and traders endemic to Tau Ceti and much of the unexplored galaxy. You and the crew have come to the Hollowstone for plunder, trade or both."
