	...
	if(candidates.len)
		...
		for (var/obj/effect/landmark/L in world)
			if(L.name == "voxstart")
				...
				new_vox << "\blue You are a Vox Primalis, fresh out of the Shoal. Your ship has arrived at the Vega system hosting the NTC Hollowstone... or was it the Luna? NSV? Utopia? Metis? Nobody is really sure, but everyong is raring to start pillaging! Your current goal is: \red<B> [input]</B>"
