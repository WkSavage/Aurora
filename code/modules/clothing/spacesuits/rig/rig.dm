...
/obj/item/rig/head/attack_self(mob/user)
	if(brightness_on)
		if(!isturf(user.loc))
...
/obj/item/rig/head/proc/update_flashlight(var/mob/user = null)
	if(on && !light_applied)
...
/obj/item/rig/New()
	...
	for(var/obj/item/piece in list(gloves,helmet,boots,chest))
		...
		if(islist(armor)) piece.armor = armor
...
/obj/item/rig/dropped(var/mob/user, var/mob/M)
	..()
	for(var/piece in list("helmet","gauntlets","chest","boots"))
