...
//		command_alert("The station has entered an ion storm.  Monitor all electronic equipment for malfunctions", "Anomaly Alert")
	...
	laws |=         list( "You must always lie.", "All answers must be in the form of a question.", "The NTC Hollowstone is a ship, not a station. You are now assigned to a ship, instead of a station." )
