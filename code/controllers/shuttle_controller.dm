...
/datum/shuttle_controller/New()
	...
	VS.arrival_message = "Attention, Hollowstone, we just tracked a small target bypassing our defensive perimeter. Can't fire on it without hitting the station - you've got incoming visitors, like it or not."
	VS.departure_message = "Your guests are pulling away, Hollowstone - moving too fast for us to draw a bead on them. Looks like they're heading out of the system at a rapid clip."
	...
	MS.arrival_message = "Attention, Hollowstone, you have a large signature approaching the station - looks unarmed to surface scans. We're too far out to intercept - brace for visitors."
	MS.departure_message = "Your visitors are on their way out of the system, Hollowstone, burning delta-v like it's nothing. Good riddance."
